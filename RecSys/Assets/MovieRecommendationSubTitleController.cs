...
public class MovieRecommendationSubTitleController : MonoBehaviour
{
    ...
    public void ChangeRecommendationSubTitleActor(int score, int baseScore, int totalScore)
    {
        ...
        textMeshPro.text = ((int)(((double)baseScore / totalScore) * 100.0f)).ToString() + "%";
    }
    ...
    public void ChangeRecommendationSubTitleRating(int score, int baseScore, int totalScore)
    {
        if (score >= baseScore)
        {
