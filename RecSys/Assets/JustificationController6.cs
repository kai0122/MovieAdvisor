...
public class JustificationController6 : MonoBehaviour
{
...
#pragma warning restore
    ...
    private void ShowRecommendationRatingDetail()
    {
        ...
        {
            /*
            movieInformationController.CloseRecommendationWhyRating_2();

            if (selectRecommendationActorWhy.hitRecommendationActorWhy)
            {
                movieInformationController.ExpendRecommendationActor_2(); ;
    ...
    private void ShowRecommendationPublicityDetail()
    {
        ...
        {
            /*
            movieInformationController.CloseRecommendationWhyPublicity_2();
    ...
    private void ShowRecommendationPublicityMoreMovies()
    {
        if (previousHitPublicityMore == true)
        {
            ...
            //movieInformationController.ExpendRecommendationWhyPublicityMore_2();
            //movieRecommendationSubTitleController.ExpendPublicityWhyMore_2();

            movieRecommendationPublicityDetailController.gameObject.SetActive(false);
        }
        else
        {
            //movieInformationController.CloseRecommendationWhyPublicityMore_2();
    ...
    private void ShowRecommendationGenreDetail()
    {
        ...
        {
            /*
            movieInformationController.CloseRecommendationWhyActor_2();
    ...
    private void ShowRecommendationGenreMore(int mode)
    {
        ...
        else if (mode == 2)
        {
            ...
            {
                //movieInformationController.CloseRecommendationWhyActorMore_1();
                //movieRecommendationSubTitleController.CloseGenreWhyMore_1();
    ...
    public void UpdateRecommendationBase_DirectControlActor(float percentage)
    {
        ...
        if (actorScoreBase != new_actorScoreBase)
        {
            ...
            movieRecommendationSubTitleController.DirectUpdateActorColor2(percentage, (float)actorScore / MIN_NUM);
        }
    }
    ...
    public void UpdateRecommendationBase_DirectControlGenre(float percentage)
    {
        ...
        if (genreScoreBase != new_genreScoreBase)
        {
            ...
            movieRecommendationSubTitleController.DirectUpdateGenreColor2(percentage, (float)genreScore / MIN_NUM);
        }
    }
    ...
    public void UpdateRecommendationBase_DirectControlPublicity(float percentage)
    {
        ...
        if (publicityScoreBase != new_puclicityScoreBase)
        {
            ...
            movieRecommendationSubTitleController.DirectUpdatePublicityColor2(percentage, (float) publicityScore / MIN_NUM);
        }
    }
