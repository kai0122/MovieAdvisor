...
public class JustificationController3 : MonoBehaviour
{
    ...
    private void UpdateRecommendationScore()
    {
        ...
        publicityScore = (double)reasonUserLikedMovies.Count / recommendationCalculator.GetUserLikedMovieNum() > 1 ? 1 : (double)reasonUserLikedMovies.Count / recommendationCalculator.GetUserLikedMovieNum();
