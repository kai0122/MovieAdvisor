...
public class SelectRecommendationGenreWhy : MonoBehaviour
{
    private Touch touch;
    public bool hitRecommendationGenreWhy;


    // Start is called before the first frame update
    void Start()
    {
        hitRecommendationGenreWhy = false;
    }
...
#pragma warning restore
                        if (hit.transform.gameObject.name == "GenreWhy")
                        {
                            if (hitRecommendationGenreWhy == true)
                            {
                                hitRecommendationGenreWhy = false;
                            }
                            else
                            {
                                hitRecommendationGenreWhy = true;
                            }
                        }
                    }
                }
