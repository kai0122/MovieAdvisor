...
public class MovieRecommendationGenreMoreController : MonoBehaviour
{
    ...
    public void UpdateRecommendationGenreDetailTitle(int totalNum, string movieType)
    {
        gameObject.transform.Find("Title").GetComponent<TMPro.TextMeshPro>().text = "All " + totalNum.ToString() + " " + movieType + " movies:";
    }
